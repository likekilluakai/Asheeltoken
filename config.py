...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6985739166:AAHlm2WhERgxK8Vv35vsx5EnFZq4cx6mi_U")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "AsheelHub_bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "25541021"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "40eff725ff77cc2f0ff3e7dc516268f8")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "6936205602")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "-1002048380715")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002076782012")) # your log channel id and make bot admin in log channel with full right 
    ...
    TECH_VJ_API = environ.get('TECH_VJ_API', '713e950c6f0c05ab7b75a634c75c11e46cb2a4a6') # your url shortner api
    TECH_VJ_TUTORIAL = os.environ.get("TECH_VJ_TUTORIAL", "https://t.me/LinksTutorials/8")
